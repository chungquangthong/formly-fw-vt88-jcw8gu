...
import { minimumMoneyValidation } from './helpers/validators';
...
export const config: ConfigOption = {
  validationMessages: [
    ...
    { name: 'maximumMoneyValidation', message: 'should be < 10000' },
    { name: 'minimumMoneyValidation', message: 'should be > 100' }
  ],
  wrappers: [
  ...
  types: [
    ...
    {name: 'datepicker', component: FormlyFieldInputDate},
